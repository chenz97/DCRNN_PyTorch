...
class DataLoader(object):
    def __init__(self, xs, ys, batch_size, pad_with_last_sample=True, shuffle=False):
        ...
        if pad_with_last_sample:
            ...
            x_padding = np.repeat(xs[-1:], num_padding, axis=0)  # the last data point
...
def load_dataset_d7(dataset_dir, batch_size, test_batch_size, seq_len, horizon, **kwargs):
    ...
    data['val_loader'] = TorchDataLoader(data['val'], batch_size=test_batch_size, shuffle=False)
    data['val_loader'].num_batch = len(data['val_loader'])
    data['test_loader'] = TorchDataLoader(data['test'], batch_size=test_batch_size, shuffle=False)
